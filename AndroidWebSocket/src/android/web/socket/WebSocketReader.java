...
public class WebSocketReader extends Thread {
    ...
    /**
     * Notify the master (foreground thread) of WebSockets message received and unwrapped.
     *
    ...
    /**
     * WebSockets text message received, default notifies master. This will only be called when the option receiveTextMessagesRaw HAS NOT been set.
     *
     * @param payload Text message payload as Java String decoded from raw UTF-8 payload or null (empty payload).
     */
    ...
    /**
     * WebSockets text message received, default notifies master. This will only be called when the option receiveTextMessagesRaw HAS been set.
     *
     * @param payload Text message payload as raw UTF-8 octets or null (empty payload).
     */
