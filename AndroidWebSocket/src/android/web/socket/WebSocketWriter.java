...
public class WebSocketWriter extends Handler {
     ...
     *
     * @param looper The message looper of the background thread on which this object is running.
    ...
    /**
     * Call this from the foreground (UI) thread to make the writer (running on background thread) send a WebSocket message on the underlying TCP.
     *
     * @param message Message to send to WebSockets writer. An instance of the message classes inside WebSocketMessage or another type which then needs to be handled within
    ...
    /**
     * Send WebSockets pong. Normally, unsolicited Pongs are not used, but Pongs are only send in response to a Ping from the peer.
     */
    ...
    /**
     * Process message received from foreground thread. This is called from the message looper set up for the background thread running this writer.
     *
    ...
    /**
     * Process WebSockets or control message from master. Normally, there should be no reason to override this. If you do, you need to know what you are doing.
     *
     * @param msg An instance of the message types within WebSocketMessage or a message that is handled in processAppMessage().
     */
    ...
    /**
     * Process message other than plain WebSockets or control message. This is intended to be overridden in derived classes.
     *
